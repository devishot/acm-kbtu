...
class SubmitsControllerTest < ActionController::TestCase
  ...
  test "should create submit" do
    assert_difference('Submit.count') do
      post :create, submit: { solution_file: @submit.solution_file, status: @submit.status, status_full: @submit.status_full }
    end
  ...
  test "should update submit" do
    put :update, id: @submit, submit: { solution_file: @submit.solution_file, status: @submit.status, status_full: @submit.status_full }
    assert_redirected_to submit_path(assigns(:submit))
  end
